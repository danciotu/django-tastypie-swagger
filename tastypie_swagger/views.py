...
from .mapping_v2 import ResourceSwagger2Mapping
...
class SwaggerView(TastypieApiMixin, TemplateView):
    ...
    # Swagger UIs for OpenAPI 1.0 specs
    # template_name = 'tastypie_swagger/index.html'
    # template_name = 'tastypie_swagger/index-2.2.10.html'

    # Swagger UIs for OpenAPI 2.0 specs
    template_name = 'tastypie_swagger/index-3.0.21.html'

    def get_context_data(self, **kwargs):
        context = super(SwaggerView, self).get_context_data(**kwargs)
        # Use OpenAPI 1.0 specs
        # context['discovery_url'] = reverse('%s:resources' % self.kwargs.get('namespace'))
        # Use OpenAPI 2.0 specs
        context['discovery_url'] = reverse('%s:specs' % self.kwargs.get('namespace'))
        return context
